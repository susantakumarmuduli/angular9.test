...
class AppComponent {
    constructor() {
        this.title = 'angular9application';
    }
}
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 4, vars: 0, consts: [["type", "text", "placeholder", "username"], ["type", "password", "placeholder", "password"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! D:\Practice\Github\angular9application\src\main.ts */"./src/main.ts");
